        ...
        IKlv: function(e, t, r) {
            ...
            var te, re = function(e) {
                    ...
                    return i(r, [{
                        ...
                        value: function() {
                            this.scrollToHash(), Q.isSsr && (j || k.nextExport && ((0, w.isDynamicRoute)(Q.pathname) || location.search) || L && L.__N_SSG && location.search) && Q.replace(Q.pathname + "?" + String(E.assign(E.urlQueryToSearchParams(Q.query), new URLSearchParams(location.search))), J, {
                                _h: 1,
                                shallow: !j
                            })
                        }
                ...
                var e = a(n.mark((function e() {
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 36:
                                return t.router = Q = (0, A.createRouter)(R, F, J, {
                                    initialProps: L,
                                    pageLoader: Y,
                                    App: K,
                                    Component: te,
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 9:
                                ...
                                throw e.t0;
                            case 13:
                                return e.next = 16, ue((0, m.default)({}, t, {
                                    err: e.t0
                                }));
                            case 16:
                            case "end":
            ...
            function se() {
                x.ST && (performance.mark("afterHydrate"), performance.measure("Next.js-before-hydration", "navigationStart", "beforeRender"), performance.measure("Next.js-hydration", "beforeRender", "afterHydrate"), Z && performance.getEntriesByName("Next.js-hydration").forEach(Z), fe())
            }
            ...
            function he(e) {
                ...
                }(), l = p, f = ee, x.ST && performance.mark("beforeRender"), ce ? (v.default.hydrate(l, f, se), ce = !1) : v.default.render(l, f, le), s
            }
